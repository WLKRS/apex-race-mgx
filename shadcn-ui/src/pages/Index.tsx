...
import { ArrowRight, Trophy, Coins, Users, Zap } from 'lucide-react';
...
export default function Index() {
  ...
  if (!connected) {
    return (
      <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center bg-gradient-to-br from-orange-50 via-white to-red-50 p-6">
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Bem-vindo de volta, {user?.username || 'Racer'}!</p>
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {inventory.cars.length} carro(s) | Nível {user?.garageLevel}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-semibold">{user?.totalRaces}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span>Ganhos Totais:</span>
                <span className="font-semibold">${user?.totalEarningsUSD.toFixed(2)}</span>
              </div>
            </div>
